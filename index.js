          ...
          <div className="jumbotron">
            <div className="card" id="quote-box">
              ...
              <div className="card-body">
                ...
                <div className="row">
                  {/* Added id="new-quote" to the button element */}
                  <button
                    id="new-quote"
                    onClick={getNewQuote}
                ...
                <a
    id="tweet-quote" // Added id="tweet-quote"
    href={
  ...
  >
                  ...
                  <a
                    href={`https://www.tumblr.com/widgets/share/tool?posttype=quote&tags=quotes&caption=${encodeURIComponent(
                      randomQuote.author
                    )}&content=${encodeURIComponent(randomQuote.text)}&canonicalUrl=https%3A%2F%2Fwww.example.com%2F&shareSource=tumblr_share_button`}
